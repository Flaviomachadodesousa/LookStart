...
class XboxOne extends StatefulWidget {
  const XboxOne({Key key}) : super(key: key);

  @override
  State<XboxOne> createState() => _XboxOneState();
}

class _XboxOneState extends State<XboxOne> {
// GET XBOXX
  List<GameModel> _notes = List<GameModel>();

  Future<List<GameModel>> fetchNotes() async {
    var url = Constants.urlXboxs;
