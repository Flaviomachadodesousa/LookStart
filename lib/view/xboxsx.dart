...
class XboxSX extends StatefulWidget {
  const XboxSX({ Key key }) : super(key: key);

  @override
  State<XboxSX> createState() => _XboxSXState();
}

class _XboxSXState extends State<XboxSX> {
// GET XBOXX
  List<GameModel> _notes = List<GameModel>();

  Future<List<GameModel>> fetchNotes() async {
    var url = Constants.urlXboxx;
